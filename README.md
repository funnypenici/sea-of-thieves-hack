...
![Downloads](https://img.shields.io/badge/Downloads-63k+-orange?style=flat-square)

Sea of Thieves Hack - game hack and trainer with full feature set. Works with the latest game update.

## Features

- Compatible with latest game version
- Works in both online and offline modes
- Freeze and modify any game value
- Supports all game modes and maps
...
Yes, all features have adjustable parameters.

**Will I get banned?**  
The tool includes anti-detection. Use responsibly.
